...
3 443 TIMER_EVENT_STOP|idle1                MOTION_ADD|mei|aisatu|Motion\mei_greeting\mei_greeting.vmd|PART|ONCE
#443 25   <eps>                             <eps>
...
445 4     <eps>                             MOTION_ADD|mei|self_introduction|Motion\mei_self_introduction\mei_self_introduction.vmd|PART|ONCE
444 446   RECOG_EVENT_STOP|いいえ           SYNTH_START|mei|mei_voice_normal|じゃあやるべきことはわかっていますね？カードのじゅんびはできましたか？
444 446   MMD_CAMERA_GET|いいえ             SYNTH_START|mei|mei_voice_normal|じゃあやるべきことはわかっていますね？カードのじゅんびはできましたか？
446 8810  <eps>                             MOTION_ADD|mei|mei_panel|Motion\mei_panel\mei_panel_on.vmd|PART|ONCE
...
6   7     SYNTH_EVENT_STOP|mei              SYNTH_START|mei|mei_voice_normal|用意したデッキからカードを5枚引いてください。その中に攻撃カードはありますか？
7   8     SYNTH_EVENT_STOP|mei              <eps>
8   9     RECOG_EVENT_STOP|はい             SYNTH_START|mei|mei_voice_normal|カードの準備は整いましたね。
8   9     RECOG_EVENT_STOP|ある             SYNTH_START|mei|mei_voice_normal|カードの準備は整いましたね。
8   9     RECOG_EVENT_STOP|あり             SYNTH_START|mei|mei_voice_normal|カードの準備は整いましたね。
8   9     MMD_CAMERA_GET|はい               SYNTH_START|mei|mei_voice_normal|カードの準備は整いましたね。
9   908   <eps>                             MOTION_ADD|mei|mei_guide_happy|Motion\mei_guide\mei_guide_happy.vmd|PART|ONCE
8   10    RECOG_EVENT_STOP|いいえ           SYNTH_START|mei|mei_voice_normal|持っているカードを全てデッキに戻して、カードをデッキから5枚引いてください。その中に攻撃カードはありますか？
8   10    RECOG_EVENT_STOP|ない             SYNTH_START|mei|mei_voice_normal|持っているカードを全てデッキに戻して、カードをデッキから5枚引いてください。その中に攻撃カードはありますか？
8   10    MMD_CAMERA_GET|いいえ             SYNTH_START|mei|mei_voice_normal|持っているカードを全てデッキに戻して、カードをデッキから5枚引いてください。その中に攻撃カードはありますか？
...
9011 9012 <eps>                             MOTION_ADD|mei|mei_panel|Motion\mei_panel\mei_panel_on.vmd|PART|ONCE
9012 9013 SYNTH_EVENT_STOP|mei              SYNTH_START|mei|mei_voice_normal|もしわたしがかてば、あなたはカードのいちぶとなり、えいえんにここからでることはできません。
9013 9014 <eps>                             MOTION_ADD|mei|self_introduction|Motion\mei_self_introduction\mei_self_introduction.vmd|PART|ONCE
9014 9015 SYNTH_EVENT_STOP|mei              SYNTH_START|mei|mei_voice_normal|かんたんですよね？
9015 9016 <eps>                             MOTION_ADD|mei|mei_guide_happy|Motion\mei_guide\mei_guide_happy.vmd|PART|ONCE
9016 9017 SYNTH_EVENT_STOP|mei              TIMER_START|wait|0.7
9017 9018 TIMER_EVENT_STOP|wait             SYNTH_START|mei|mei_voice_normal|ただのこうげきカードだけではつまらないので”とくしゅカード”もよういしました。
9018 9019 SYNTH_EVENT_STOP|mei              SYNTH_START|mei|mei_voice_normal|ふつうのこうかははつどうできますが、ミッションをクリアするとこうかをアップしてはつどうできます。がんばってください。
9019 9020 SYNTH_EVENT_STOP|mei              TIMER_START|wait|0.7
9020 9021 TIMER_EVENT_STOP|wait             SYNTH_START|mei|mei_voice_normal|ここからがちゅういです。ターン中に1かいしかこうげきカードがつかえません。
9021 9022 <eps>                             MOTION_ADD|mei|mei_imagine_left_normal|Motion\mei_imagine\mei_imagine_left_normal.vmd|PART|ONCE
9022 9023 SYNTH_EVENT_STOP|mei              SYNTH_START|mei|mei_voice_normal|こうげきがおわったらあなたのターンはおわりなのできをつけてください。こうげきカードいがいのカードはなんかいでもつかえます。
9023 9100 SYNTH_EVENT_STOP|mei              TIMER_START|wait|0.7
...
9102 9103 RECOG_EVENT_STOP|ない             SYNTH_START|mei|mei_voice_normal|せつめいはこれでおわりです。ではバトルをはじめましょう。ここをでるためにわたしをたおしてください！
9102 9103 RECOG_EVENT_STOP|いいえ           SYNTH_START|mei|mei_voice_normal|せつめいはこれでおわりです。ではバトルをはじめましょう。ここをでるためにわたしをたおしてください！
9102 9103 MMD_CAMERA_GET|ない               SYNTH_START|mei|mei_voice_normal|せつめいはこれでおわりです。ではバトルをはじめましょう。ここをでるためにわたしをたおしてください！
